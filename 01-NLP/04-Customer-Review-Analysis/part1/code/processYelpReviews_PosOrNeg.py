...
def main(save_sample, save_categories):
            ...
            if rid in sample_rid2cat:
                for rcat in sample_rid2cat [ rid ]:
                    ...
                    if rcat in sample_cat2reviews:
                        if (review_json['stars'] == 4) or (review_json['stars'] == 5):#1 or 2 for neg, 4 or 5 for pos reviews
    ...
    if save_sample:  
        ...
        sample_size = min(150000, num_reviews)
        ...
        with open ("review_positive_sample_150000.txt", 'w') as f:
            f.write('\n'.join(my_sample_v2).encode('ascii','ignore') )
            
        with open ("review_positive_ratings_150000.txt", 'w') as f:
