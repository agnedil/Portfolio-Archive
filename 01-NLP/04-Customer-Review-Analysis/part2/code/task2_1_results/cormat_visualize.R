library(readr)
setwd('/home/andrew/Documents/2_UIUC/CS598_Data_Mining_Capstone/task2/task2_pycharms_project/task2_2_results')
mydata <- read_csv("2_2_lda2.csv", col_names=TRUE, progress = FALSE)
