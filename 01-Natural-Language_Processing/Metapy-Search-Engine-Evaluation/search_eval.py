...
class InL2Ranker(metapy.index.RankingFunction):
    ...
    def score_one(self, sd):
        """
        Return the score for a single term.
...
def load_ranker(cfg_file):
    ...
    #Best BM25 k1 value:
    return metapy.index.OkapiBM25(k1=2.16, b=0.63, k3=500)

    #Best InL2 c value:
    #return InL2Ranker(some_param=0.987)

    #return metapy.index.PivotedLength(s = 0.348)
...
if __name__ == '__main__':
    ...
    with open(query_path) as query_file, open ("other.avg_p.txt", "w") as f:
