...
public class TopWordFinderTopologyPartD {
  ...
  public static void main(String[] args) throws Exception {
    ...
    /* TODO:
    Wire up the topology using the setBolt(name,…) and setSpout(name,…),
    and the following names of components:    
    FileReaderSpout -> "spout", SplitSentenceBolt -> "split"
    WordCountBolt -> "count", NormalizerBolt -> "normalize", TopNFinderBolt -> "top-n" */
